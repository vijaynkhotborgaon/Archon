...
<p style="color:#31B0D5;">Products > <span style="color:#31B0D5;">Networking ></span><span style="color:black;"> Application Delivery Controllers</span></p>
...
<img src="images/Networks_Page.jpg" class="img-responsive " alt="Responsive image" style="height:200px;width:100%;">
</div>
...
<h4><b>Application Delivery Controllers</b></h4>
...
<div class="row" style="padding:3px;" >
  ...
  <h5><b>Link Load Balancers</b></h5>
	 
	  <div class="col-xs-5" style="background-color:#F1F1F1;padding-left:0px;">
	  
	  <img src="images/20090701_797987_image013_641567_57_0.png" class="img-responsive " alt="Responsive image" style="margin-bottom:10px; "></div>
	  
	  
	 
	  <p style="margin-top:10px; ">Link load balancing provides advanced failover and bandwidth management for multiple WAN connections to assure continuous operation of enterprise applications and cloud services in the event that one or more ISP links become unavailable or slow to respond</p>
  ...
  <div class="col-xs-6" style="border-left:20px solid white;background-color:#F1F1F1;">
	  ...
	  <h5><b>Server Load Balancers</b></h5>
	 
	  <div class="col-xs-5" style="background-color:#F1F1F1;padding-left:0px;">
	  
	  <img src="images/20110930_1257553_image001_725713_1285_0.png" class="img-responsive " alt="Responsive image"></div>
	  
	  
	 
	  <p style="margin-top:10px;">Server load balancing provides scalability and high availability for applications, Web sites and cloud services by monitoring the health of servers, evenly distributing loads across servers and maintaining session persistence and a seamless user experience in the event that one or more servers become overburdened or unresponsive.</p>
...
<div class="row" style="padding:3px;">
  <div class="col-xs-6" style="background-color:#F1F1F1;">
	  ...
	  <h5><b>WAN Optimization</b></h5>
	 
	  <div class="col-xs-5" style="background-color:#F1F1F1;padding-left:0px;">
	  
	  <img src="images/network_large.jpg" class="img-responsive " alt="Responsive image" ></div>
  ...
  <div class="col-xs-6" style="border-left:20px solid white;background-color:#F1F1F1;" >
	  ...
	  <h5><b>Proxy Solutions</b></h5>
	 
	  <div class="col-xs-5" style="background-color:#F1F1F1;padding-left:0px;">
	  
	  <img src="images/imageedit_8_5108459495.png" class="img-responsive " alt="Responsive image"></div>
