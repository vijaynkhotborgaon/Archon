...
<p style="color:#31B0D5;">Products > <span style="color:#31B0D5;">Networking ></span><span style="color:black;"> Management</span></p>
...
<img src="images/inner-banner-management-1920x439.jpg" class="img-responsive " alt="Responsive image" style="height:200px;width:100%;">
</div>
...
<div class="row" style="padding:3px;" >
  ...
  <h5><b>Network Performance Monitoring</b></h5>
	 
	  <div class="col-xs-5" style="background-color:#F1F1F1;padding-left:0px;">
	  
	  <img src="images/best-network-performance-monitoring-tool-1-638.jpg" class="img-responsive " alt="Responsive image" style="margin-bottom:10px; "></div>
	  
	  
	 
	  <p style="margin-top:10px; ">Multi-vendor network monitoring software for fault, performance and availabilty monitoring</p>
  ...
  <div class="col-xs-6" style="border-left:20px solid white;background-color:#F1F1F1;">
	  ...
	  <h5><b>Network Management Software</b></h5>
	 
	  <div class="col-xs-5" style="background-color:#F1F1F1;padding-left:0px;">
	  
	  <img src="images/imageedit_10_9939345363.jpg" class="img-responsive " alt="Responsive image"></div>
	  
	  
	 
	  <p style="margin-top:10px;">Helping to assure the health and availability of business services with centralized, proactive performance management of the IT infrastructure.
Demonstrating IT business value to executive and business stakeholders with extensive reporting for performance and capacity planning.</p>
...
<div class="row" style="padding:3px;">
  <div class="col-xs-6" style="background-color:#F1F1F1;">
	  ...
	  <h5><b>Network Capacity Planning</b></h5>
	 
	  <div class="col-xs-5" style="background-color:#F1F1F1;padding-left:0px;">
	  
	  <img src="images/capacity.jpe" class="img-responsive " alt="Responsive image" ></div>
	  
	  
	 
	  <p style="margin-top:10px;">Automated capacity forecasting, alerting, and reporting
Automatically calculate exhaustion dates using customizable thresholds based on peak and average usage</p>
